...
var require_canvaskit = __commonJS({
  "node_modules/canvaskit-wasm/bin/full/canvaskit.js"(exports, module) {
    var CanvasKitInit = (() => {
      var _scriptDir = typeof document !== "undefined" && document.currentScript ? document.currentScript.src : void 0;
      if (typeof __filename !== "undefined") _scriptDir = _scriptDir || __filename;
      return function(moduleArg = {}) {
        var w = moduleArg, aa, ba;
        ...
        (function(a) {
          ...
          a.ke.push(function() {
            a.MakeSWCanvasSurface = function(b) {
              ...
              if (b = a.MakeSurface(d.width, d.height)) b.de = d;
              return b;
            };
            ...
            a.MakeSurface = function(b, d) {
              ...
              if (f = a.Surface._makeRasterDirect(f, m, 4 * b)) f.de = null, f.Yf = b, f.Uf = d, f.Wf = h, f.xf = m, f.getCanvas().clear(a.TRANSPARENT);
              return f;
            };
            ...
            a.Surface.prototype.flush = function(b) {
              ...
              this._flush();
              if (this.de) {
                var d = new Uint8ClampedArray(a.HEAPU8.buffer, this.xf, this.Wf);
                d = new ImageData(d, this.Yf, this.Uf);
                b ? this.de.getContext("2d").putImageData(
                  d,
                  0,
                  0,
                  b[0],
                  ...
                  b[2] - b[0],
                  b[3] - b[1]
                ) : this.de.getContext("2d").putImageData(d, 0, 0);
              }
            };
            a.Surface.prototype.dispose = function() {
              this.xf && a._free(this.xf);
              this.delete();
            };
            a.ee = a.ee || function() {
            };
        ...
        (function(a) {
          ...
          a.ke.push(function() {
            ...
            a.GetWebGLContext = function(n, p) {
              ...
              if (!n) return 0;
              ja(n);
              A.ye.getExtension("WEBGL_debug_renderer_info");
              return n;
            };
            a.deleteContext = function(n) {
              A === ka[n] && (A = null);
              "object" == typeof JSEvents && JSEvents.Qg(ka[n].ye.canvas);
              ka[n] && ka[n].ye.canvas && (ka[n].ye.canvas.Sf = void 0);
              ka[n] = null;
            };
            a._setTextureCleanup({ deleteTexture: function(n, p) {
              var v = da[p];
              v && ka[n].ye.deleteTexture(v);
              da[p] = null;
            } });
            a.MakeWebGLContext = function(n) {
              if (!this.ee(n)) return null;
            ...
            a.MakeOnScreenGLSurface = function(n, p, v, E, G, L) {
              if (!this.ee(n.ce)) return null;
              p = void 0 === G || void 0 === L ? this._MakeOnScreenGLSurface(n, p, v, E) : this._MakeOnScreenGLSurface(n, p, v, E, G, L);
              if (!p) return null;
              p.ce = n.ce;
              return p;
            };
            ...
            a.MakeWebGLCanvasSurface = function(n, p, v) {
              ...
              if (!("undefined" !== typeof HTMLCanvasElement && E instanceof HTMLCanvasElement || G || (E = document.getElementById(n), E))) throw "Canvas with id " + n + " was not found";
            ...
            a.Surface.prototype.makeImageFromTexture = function(n, p) {
              a.ee(this.ce);
              n = d(n);
              if (p = this._makeImageFromTexture(this.ce, n, p)) p.df = n;
              return p;
            };
            ...
            a.Surface.prototype.updateTextureFromSource = function(n, p, v) {
              if (n.df) {
                a.ee(this.ce);
                var E = n.getImageInfo(), G = A.ye, L = m(G, da[n.df], E, v);
                2 === A.version ? G.texImage2D(G.TEXTURE_2D, 0, G.RGBA, h(p), f(p), 0, G.RGBA, G.UNSIGNED_BYTE, p) : G.texImage2D(G.TEXTURE_2D, 0, G.RGBA, G.RGBA, G.UNSIGNED_BYTE, p);
                u(G, E, v);
                this._resetContext();
                da[n.df] = null;
                n.df = d(L);
                E.colorSpace = n.getColorSpace();
                p = this._makeImageFromTexture(this.ce, n.df, E);
                v = n.be.je;
                G = n.be.qe;
                n.be.je = p.be.je;
                n.be.qe = p.be.qe;
            ...
            a.MakeLazyImageFromTextureSource = function(n, p, v) {
              ...
              var E = { makeTexture: function() {
                var G = A, L = G.ye, y = m(L, L.createTexture(), p, v);
            ...
            a.nf = function() {
              return A && A.Bf && !A.Bf.isDeleted() ? A.Bf : null;
            };
          });
        })(w);
        (function(a) {
          ...
          function E(e) {
            var c = { ue: V, count: e.length, colorType: a.ColorType.RGBA_F32 };
            if (e instanceof Float32Array) c.ue = v(e, "HEAPF32"), c.count = e.length / 4;
            else if (e instanceof Uint32Array) c.ue = v(e, "HEAPU32"), c.colorType = a.ColorType.RGBA_8888;
            else if (e instanceof Array) {
              if (e && e.length) {
                for (var g = a._malloc(16 * e.length), l = 0, r = g / 4, x = 0; x < e.length; x++) for (var C = 0; 4 > C; C++) a.HEAPF32[r + l] = e[x][C], l++;
                e = g;
              } else e = V;
              c.ue = e;
          ...
          function G(e) {
            ...
            if (e.length) {
              if (6 === e.length || 9 === e.length) return v(e, "HEAPF32", Oa), 6 === e.length && a.HEAPF32.set(Hd, 6 + Oa / 4), Oa;
          ...
          function R(e, c) {
            return v(e, "HEAPF32", c || ea);
          }
          function ta(e, c) {
            return v(e, "HEAPF32", c || ac);
          }
          function pa() {
          ...
          function jb(e, c, g) {
            for (var l = Array(e.length), r = 0; r < g; r++) for (var x = 0; x < g; x++) {
          ...
          function kb(e, c) {
            for (var g = jb(c[0], c[1], e), l = 2; l < c.length; ) g = jb(g, c[l], e), l++;
            return g;
          }
          ...
          a.Malloc = function(e, c) {
            ...
            return { _ck: true, length: c, byteOffset: g, Ke: null, subarray: function(l, r) {
              ...
              this.Ke = new e(a.HEAPU8.buffer, g, c);
              this.Ke._ck = true;
              return this.Ke;
            } };
          };
          ...
          var Oa = V, Yb, bb = V, Zb, Ka = V, $b, sa, ea = V, Ac, Pa = V, bc, cb = V, Bc, cc = V, Bb, lb = V, Cc, ac = V, Dc, Ec = V, Hd = Float32Array.of(0, 0, 1), V = 0;
          a.onRuntimeInitialized = function() {
            ...
            a.Path.MakeFromVerbsPointsWeights = function(c, g, l) {
              var r = v(c, "HEAPU8"), x = v(g, "HEAPF32"), C = v(l, "HEAPF32"), J = a.Path._MakeFromVerbsPointsWeights(r, c.length, x, g.length, C, l && l.length || 0);
              p(r, c);
              p(x, g);
              p(C, l);
              return J;
            ...
            a.Path.prototype.addVerbsPointsWeights = function(c, g, l) {
              var r = v(c, "HEAPU8"), x = v(g, "HEAPF32"), C = v(l, "HEAPF32");
            ...
            a.Canvas.prototype.drawAtlas = function(c, g, l, r, x, C, J) {
              if (c && r && g && l && g.length === l.length) {
                ...
                var N = v(g, "HEAPF32"), P = v(l, "HEAPF32"), Y = l.length / 4, W = v(m(C), "HEAPU32");
                if (J && "B" in J && "C" in J) this._drawAtlasCubic(c, P, N, W, Y, x, J.B, J.C, r);
                else {
                  let t = a.FilterMode.Linear, D = a.MipmapMode.None;
            ...
            a.Canvas.prototype.drawImageRect = function(c, g, l, r, x) {
              ...
              R(g, ea);
              R(l, Pa);
              this._drawImageRect(c, ea, Pa, r, !!x);
            };
            a.Canvas.prototype.drawImageRectCubic = function(c, g, l, r, x, C) {
              a.ee(this.ce);
              R(g, ea);
              R(l, Pa);
              this._drawImageRectCubic(c, ea, Pa, r, x, C || null);
            };
            a.Canvas.prototype.drawImageRectOptions = function(c, g, l, r, x, C) {
              a.ee(this.ce);
              R(g, ea);
              R(l, Pa);
              this._drawImageRectOptions(c, ea, Pa, r, x, C || null);
            };
            ...
            a.Canvas.prototype.drawPatch = function(c, g, l, r, x) {
              ...
              a.ee(this.ce);
              const C = v(c, "HEAPF32"), J = g ? v(m(g), "HEAPU32") : V, N = l ? v(l, "HEAPF32") : V;
            ...
            a.Canvas.prototype.drawShadow = function(c, g, l, r, x, C, J) {
              a.ee(this.ce);
              var N = v(x, "HEAPF32"), P = v(C, "HEAPF32");
              g = v(g, "HEAPF32", cb);
              l = v(l, "HEAPF32", cc);
            ...
            a.getShadowLocalBounds = function(c, g, l, r, x, C, J) {
              ...
              l = v(l, "HEAPF32", cb);
              r = v(r, "HEAPF32", cc);
              if (!this._getShadowLocalBounds(c, g, l, r, x, C, ea)) return null;
              g = sa.toTypedArray();
            ...
            a.Canvas.prototype.getLocalToDevice = function() {
              this._getLocalToDevice(bb);
              for (var c = bb, g = Array(16), l = 0; 16 > l; l++) g[l] = a.HEAPF32[c / 4 + l];
              return g;
            };
            ...
            a.Canvas.prototype.saveLayer = function(c, g, l, r, x) {
              g = R(g);
              return this._saveLayer(c || null, g, l || null, r || 0, x || a.TileMode.Clamp);
            };
            a.Canvas.prototype.writePixels = function(c, g, l, r, x, C, J, N) {
              ...
              P = v(c, "HEAPU8");
              g = this._writePixels(
                { width: g, height: l, colorType: J, alphaType: C, colorSpace: N },
                P,
                Y,
                r,
                x
            ...
            a.ImageFilter.MakeImage = function(c, g, l, r) {
              ...
              return a.ImageFilter._MakeImageOptions(
                c,
                x,
                C,
                l,
            ...
            a.Surface.prototype.Xf = function(c, g) {
              this.$e || (this.$e = this.getCanvas());
            ...
            a.Surface.prototype.requestAnimationFrame || (a.Surface.prototype.requestAnimationFrame = a.Surface.prototype.Xf);
            a.Surface.prototype.Tf = function(c, g) {
              this.$e || (this.$e = this.getCanvas());
            ...
            a.Surface.prototype.drawOnce || (a.Surface.prototype.drawOnce = a.Surface.prototype.Tf);
            ...
            a.Shader.MakeRadialGradient = function(c, g, l, r, x, C, J, N) {
              ...
              J = J || 0;
              C = G(C);
              c = a.Shader._MakeRadialGradient(c[0], c[1], g, P.ue, P.colorType, Y, P.count, x, J, C, N);
              p(P.ue, l);
              r && p(Y, r);
              return c;
            };
            a.Shader.MakeSweepGradient = function(c, g, l, r, x, C, J, N, P, Y) {
              Y = Y || null;
              var W = E(l), t = v(r, "HEAPF32");
              J = J || 0;
              N = N || 0;
              P = P || 360;
              C = G(C);
              c = a.Shader._MakeSweepGradient(c, g, W.ue, W.colorType, t, W.count, x, N, P, J, C, Y);
              p(W.ue, l);
              r && p(t, r);
              return c;
            };
            a.Shader.MakeTwoPointConicalGradient = function(c, g, l, r, x, C, J, N, P, Y) {
              Y = Y || null;
              var W = E(x), t = v(C, "HEAPF32");
              P = P || 0;
              N = G(N);
              var D = sa.toTypedArray();
              D.set(c);
              D.set(l, 2);
              c = a.Shader._MakeTwoPointConicalGradient(ea, g, r, W.ue, W.colorType, t, W.count, J, P, N, Y);
              p(W.ue, x);
              C && p(t, C);
              return c;
            };
          ...
          a.MakeImageFromCanvasImageSource = function(e) {
            ...
            mb.width = c;
            mb.height = g;
            var l = mb.getContext("2d", { willReadFrequently: true });
            l.drawImage(e, 0, 0);
          ...
          a.Matrix.mapPoints = function(e, c) {
            for (var g = 0; g < c.length; g += 2) {
              var l = c[g], r = c[g + 1], x = e[6] * l + e[7] * r + e[8], C = e[3] * l + e[4] * r + e[5];
          ...
          a.Matrix.rotated = function(e, c, g) {
            ...
            var l = Math.sin(e);
            e = Math.cos(e);
            return [e, -l, pa(l, g, 1 - e, c), l, e, pa(-l, c, 1 - e, g), 0, 0, 1];
          };
          ...
          a.M44.rotatedUnitSinCos = function(e, c, g) {
            ...
            e = e[2];
            var x = 1 - g;
            return [x * l * l + g, x * l * r - c * e, x * l * e + c * r, 0, x * l * r + c * e, x * r * r + g, x * r * e - c * l, 0, x * l * e - c * r, x * r * e + c * l, x * e * e + g, 0, 0, 0, 0, 1];
          };
          ...
          a.M44.invert = function(e) {
            var c = e[0], g = e[4], l = e[8], r = e[12], x = e[1], C = e[5], J = e[9], N = e[13], P = e[2], Y = e[6], W = e[10], t = e[14], D = e[3], U = e[7], fa = e[11];
            e = e[15];
            var la = c * C - g * x, ua = c * J - l * x, ya = c * N - r * x, Fa = g * J - l * C, ha = g * N - r * C, I = l * N - r * J, k = P * U - Y * D, q = P * fa - W * D, z = P * e - t * D, B = Y * fa - W * U, F = Y * e - t * U, H = W * e - t * fa, O = la * H - ua * F + ya * B + Fa * z - ha * q + I * k, Z = 1 / O;
            ...
            F *= Z;
            H *= Z;
            c = [C * H - J * F + N * B, J * z - x * H - N * q, x * F - C * z + N * k, C * q - x * B - J * k, l * F - g * H - r * B, c * H - l * z + r * q, g * z - c * F - r * k, c * B - g * q + l * k, U * I - fa * ha + e * Fa, fa * ya - D * I - e * ua, D * ha - U * ya + e * la, U * ua - D * Fa - fa * la, W * ha - Y * I - t * Fa, P * I - W * ya + t * ua, Y * ya - P * ha - t * la, P * Fa - Y * ua + W * la];
            return c.every(function(qa) {
          ...
          var Id = [[6, 7, 11, 12], [0, 10, 2, 12], [0, 1, 5, 6]];
          ...
          a.ColorMatrix.concat = function(e, c) {
            for (var g = new Float32Array(20), l = 0, r = 0; 20 > r; r += 5) {
              for (var x = 0; 4 > x; x++) g[l++] = e[r] * c[x] + e[r + 1] * c[x + 5] + e[r + 2] * c[x + 10] + e[r + 3] * c[x + 15];
            ...
            e.ke.push(function() {
              ...
              function g(t) {
                ...
                for (var D = [], U = 0; U < t.length; U += 5) {
                  var fa = e.LTRBRect(t[U], t[U + 1], t[U + 2], t[U + 3]), la = e.TextDirection.LTR;
                  0 === t[U + 4] && (la = e.TextDirection.RTL);
                  D.push({ rect: fa, dir: la });
                }
              ...
              function C(t) {
                ...
                Array.isArray(t.fontFamilies) && t.fontFamilies.length ? (t._fontFamiliesPtr = r(t.fontFamilies), t._fontFamiliesLen = t.fontFamilies.length) : (t._fontFamiliesPtr = V, t._fontFamiliesLen = 0);
                if (t.locale) {
                  var D = t.locale;
                  t._localePtr = x(D);
                  t._localeLen = ma(D);
                ...
                if (Array.isArray(t.shadows) && t.shadows.length) {
                  D = t.shadows;
                  var U = D.map(function(ha) {
                    return ha.color || e.BLACK;
                  }), fa = D.map(function(ha) {
                    return ha.blurRadius || 0;
                  });
                  t._shadowLen = D.length;
                  for (var la = e._malloc(8 * D.length), ua = la / 4, ya = 0; ya < D.length; ya++) {
                    var Fa = D[ya].offset || [0, 0];
                    e.HEAPF32[ua] = Fa[0];
                    e.HEAPF32[ua + 1] = Fa[1];
                    ua += 2;
                  }
                  t._shadowColorsPtr = E(U).ue;
                  t._shadowOffsetsPtr = la;
                  t._shadowBlurRadiiPtr = v(fa, "HEAPF32");
                } else t._shadowLen = 0, t._shadowColorsPtr = V, t._shadowOffsetsPtr = V, t._shadowBlurRadiiPtr = V;
                Array.isArray(t.fontFeatures) && t.fontFeatures.length ? (D = t.fontFeatures, U = D.map(function(ha) {
                  return ha.name;
                }), fa = D.map(function(ha) {
                  return ha.value;
                }), t._fontFeatureLen = D.length, t._fontFeatureNamesPtr = r(U), t._fontFeatureValuesPtr = v(fa, "HEAPU32")) : (t._fontFeatureLen = 0, t._fontFeatureNamesPtr = V, t._fontFeatureValuesPtr = V);
                Array.isArray(t.fontVariations) && t.fontVariations.length ? (D = t.fontVariations, U = D.map(function(ha) {
                  return ha.axis;
                }), fa = D.map(function(ha) {
                  return ha.value;
                }), t._fontVariationLen = D.length, t._fontVariationAxesPtr = r(U), t._fontVariationValuesPtr = v(fa, "HEAPF32")) : (t._fontVariationLen = 0, t._fontVariationAxesPtr = V, t._fontVariationValuesPtr = V);
              }
              function J(t) {
              ...
              e.Paragraph.prototype.getRectsForRange = function(t, D, U, fa) {
                t = this._getRectsForRange(t, D, U, fa);
                return g(t);
              };
              ...
              e.ParagraphStyle = function(t) {
                ...
                t.replaceTabCharacters = t.replaceTabCharacters || false;
                D = (D = t.strutStyle) || {};
                D.strutEnabled = D.strutEnabled || false;
                D.strutEnabled && Array.isArray(D.fontFamilies) && D.fontFamilies.length ? (D._fontFamiliesPtr = r(D.fontFamilies), D._fontFamiliesLen = D.fontFamilies.length) : (D._fontFamiliesPtr = V, D._fontFamiliesLen = 0);
                ...
                t.applyRoundingHack = false !== t.applyRoundingHack;
                return t;
              };
              ...
              var N = {}, P = e._malloc(16), Y = e._malloc(16), W = e._malloc(16);
              e.ParagraphBuilder.Make = function(t, D) {
                C(t.textStyle);
                D = e.ParagraphBuilder._Make(
                  t,
                  D
                );
                J(t.textStyle);
              ...
              e.ParagraphBuilder.ShapeText = function(t, D, U) {
                let fa = 0;
                for (const la of D) fa += la.length;
                if (fa !== t.length) throw "Accumulated block lengths must equal text.length";
                return e.ParagraphBuilder._ShapeText(
                  t,
                  D,
                  U
                );
              ...
              e.ParagraphBuilder.prototype.addPlaceholder = function(t, D, U, fa, la) {
                U = U || e.PlaceholderAlignment.Baseline;
                fa = fa || e.TextBaseline.Alphabetic;
                this._addPlaceholder(t || 0, D || 0, U, fa, la || 0);
              };
          ...
          a.MakeManagedAnimation = function(e, c, g, l, r) {
            ...
            for (var x = [], C = [], J = [], N = Object.keys(c || {}), P = 0; P < N.length; P++) {
              var Y = N[P], W = new Uint8Array(c[Y]), t = a._malloc(W.byteLength);
              a.HEAPU8.set(W, t);
              C.push(t);
              J.push(W.byteLength);
              W = ma(Y) + 1;
          ...
          a.Lg = function(e) {
            ...
            e.vertAlign = e.vertAlign || a.Mg.Top;
          ...
          a.ke.push(function() {
            ...
            a.Font.prototype.getGlyphIntercepts = function(e, c, g, l) {
              var r = v(e, "HEAPU16"), x = v(c, "HEAPF32");
            ...
            a.FontMgr.FromData = function() {
              ...
              for (var c = [], g = [], l = 0; l < e.length; l++) {
                var r = new Uint8Array(e[l]), x = v(r, "HEAPU8");
                c.push(x);
                g.push(r.byteLength);
              }
              c = v(c, "HEAPU32");
            ...
            a.TextBlob.MakeOnPath = function(e, c, g, l) {
              if (e && e.length && c && c.countPoints()) {
                if (1 === c.countPoints()) return this.MakeFromText(
                  e,
                  g
                );
                l || (l = 0);
          ...
          a.ke.push(function() {
            ...
            a.RuntimeEffect.MakeForBlender = function(e, c) {
              return a.RuntimeEffect._MakeForBlender(
                e,
            ...
            a.RuntimeEffect.prototype.makeShaderWithChildren = function(e, c, g) {
              ...
              g = G(g);
              for (var x = [], C = 0; C < c.length; C++) x.push(c[C].be.je);
              c = v(x, "HEAPU32");
          ...
          (function() {
            function e(I) {
              for (var k = 0; k < I.length; k++) if (void 0 !== I[k] && !Number.isFinite(I[k])) return false;
              return true;
            }
            function c(I) {
              ...
              var q = k[1], z = k[2];
              k = k[3];
              if (1 === k) return I = I.toString(16).toLowerCase(), q = q.toString(16).toLowerCase(), z = z.toString(16).toLowerCase(), I = 1 === I.length ? "0" + I : I, q = 1 === q.length ? "0" + q : q, z = 1 === z.length ? "0" + z : z, "#" + I + q + z;
            ...
            function r() {
              ha || (ha = { "Noto Mono": { "*": a.Typeface.GetDefault() }, monospace: { "*": a.Typeface.GetDefault() } });
            }
            function x(I) {
              this.de = I;
              this.ge = new a.Paint();
              this.ge.setAntiAlias(true);
              this.ge.setStrokeMiter(10);
              this.ge.setStrokeCap(a.StrokeCap.Butt);
              this.ge.setStrokeJoin(a.StrokeJoin.Miter);
              this.lf = "10px monospace";
              this.Ge = new a.Font(a.Typeface.GetDefault(), 10);
              this.Ge.setSubpixel(true);
              this.te = this.ze = a.BLACK;
              this.Pe = 0;
              this.bf = a.TRANSPARENT;
              this.Re = this.Qe = 0;
              this.cf = this.Ce = 1;
              this.af = 0;
              this.Oe = [];
              this.fe = a.BlendMode.SrcOver;
              this.ge.setStrokeWidth(this.cf);
              this.ge.setBlendMode(this.fe);
              this.ie = new a.Path();
              this.le = a.Matrix.identity();
              this.Gf = [];
              this.Ve = [];
              this.Fe = function() {
                this.ie.delete();
              ...
              Object.defineProperty(this, "currentTransform", { enumerable: true, get: function() {
                return { a: this.le[0], c: this.le[1], e: this.le[2], b: this.le[3], d: this.le[4], f: this.le[5] };
              }, set: function(k) {
                k.a && this.setTransform(k.a, k.b, k.c, k.d, k.e, k.f);
              } });
              Object.defineProperty(this, "fillStyle", { enumerable: true, get: function() {
                return f(this.te) ? c(this.te) : this.te;
              }, set: function(k) {
                "string" === typeof k ? this.te = g(k) : k.Ne && (this.te = k);
              } });
              Object.defineProperty(this, "font", { enumerable: true, get: function() {
                ...
                var B = q.family;
                r();
                z = ha[B] ? ha[B][z] || ha[B]["*"] : a.Typeface.GetDefault();
                q.typeface = z;
                q && (this.Ge.setSize(q.sizePx), this.Ge.setTypeface(q.typeface), this.lf = k);
              } });
              Object.defineProperty(this, "globalAlpha", { enumerable: true, get: function() {
                return this.Ce;
              }, set: function(k) {
                !isFinite(k) || 0 > k || 1 < k || (this.Ce = k);
              } });
              Object.defineProperty(this, "globalCompositeOperation", { enumerable: true, get: function() {
                ...
                switch (k) {
                  ...
                  case "destination-over":
                    this.fe = a.BlendMode.DstOver;
                    break;
                  case "copy":
                    this.fe = a.BlendMode.Src;
                    break;
                  case "destination":
                    this.fe = a.BlendMode.Dst;
                    break;
                  case "clear":
                    this.fe = a.BlendMode.Clear;
                    break;
                  case "source-in":
                    this.fe = a.BlendMode.SrcIn;
                    break;
                  case "destination-in":
                    this.fe = a.BlendMode.DstIn;
                    break;
                  case "source-out":
                    this.fe = a.BlendMode.SrcOut;
                    break;
                  case "destination-out":
                    this.fe = a.BlendMode.DstOut;
                    break;
                  case "source-atop":
                    this.fe = a.BlendMode.SrcATop;
                    break;
                  case "destination-atop":
                    this.fe = a.BlendMode.DstATop;
                    break;
                  case "xor":
                    this.fe = a.BlendMode.Xor;
                    break;
                  case "lighter":
                    this.fe = a.BlendMode.Plus;
                    break;
                  case "plus-lighter":
                    this.fe = a.BlendMode.Plus;
                    break;
                  ...
                  case "multiply":
                    this.fe = a.BlendMode.Multiply;
                    break;
                  case "screen":
                    this.fe = a.BlendMode.Screen;
                    break;
                  case "overlay":
                    this.fe = a.BlendMode.Overlay;
                    break;
                  case "darken":
                    this.fe = a.BlendMode.Darken;
                    break;
                  case "lighten":
                    this.fe = a.BlendMode.Lighten;
                    break;
                  case "color-dodge":
                    this.fe = a.BlendMode.ColorDodge;
                    break;
                  case "color-burn":
                    this.fe = a.BlendMode.ColorBurn;
                    break;
                  case "hard-light":
                    this.fe = a.BlendMode.HardLight;
                    break;
                  case "soft-light":
                    this.fe = a.BlendMode.SoftLight;
                    break;
                  case "difference":
                    this.fe = a.BlendMode.Difference;
                    break;
                  case "exclusion":
                    this.fe = a.BlendMode.Exclusion;
                    break;
                  case "hue":
                    this.fe = a.BlendMode.Hue;
                    break;
                  case "saturation":
                    this.fe = a.BlendMode.Saturation;
                    break;
                  case "color":
                    this.fe = a.BlendMode.Color;
                    break;
                  case "luminosity":
                    this.fe = a.BlendMode.Luminosity;
                    break;
                  default:
                    return;
                }
              ...
              Object.defineProperty(this, "lineCap", { enumerable: true, get: function() {
                ...
                switch (k) {
                  case "butt":
                    ...
                    break;
                  case "round":
                    this.ge.setStrokeCap(a.StrokeCap.Round);
                    break;
                  case "square":
                    this.ge.setStrokeCap(a.StrokeCap.Square);
                }
              } });
              Object.defineProperty(
                this,
              ...
              Object.defineProperty(this, "lineJoin", { enumerable: true, get: function() {
                ...
                switch (k) {
                  case "miter":
                    ...
                    break;
                  case "round":
                    this.ge.setStrokeJoin(a.StrokeJoin.Round);
                    break;
                  case "bevel":
                    this.ge.setStrokeJoin(a.StrokeJoin.Bevel);
                }
              } });
              Object.defineProperty(this, "lineWidth", { enumerable: true, get: function() {
                return this.ge.getStrokeWidth();
              }, set: function(k) {
                0 >= k || !k || (this.cf = k, this.ge.setStrokeWidth(k));
              } });
              Object.defineProperty(this, "miterLimit", { enumerable: true, get: function() {
                return this.ge.getStrokeMiter();
              }, set: function(k) {
                0 >= k || !k || this.ge.setStrokeMiter(k);
              } });
              Object.defineProperty(this, "shadowBlur", { enumerable: true, get: function() {
                return this.Pe;
              }, set: function(k) {
                0 > k || !isFinite(k) || (this.Pe = k);
              } });
              Object.defineProperty(
                this,
                "shadowColor",
              ...
              this.clearRect = function(k, q, z, B) {
                this.ge.setStyle(a.PaintStyle.Fill);
                this.ge.setBlendMode(a.BlendMode.Clear);
                this.de.drawRect(a.XYWHRect(k, q, z, B), this.ge);
                this.ge.setBlendMode(this.fe);
              };
              this.clip = function(k, q) {
                "string" === typeof k ? (q = k, k = this.ie) : k && k.wf && (k = k.me);
                k || (k = this.ie);
                k = k.copy();
                q && "evenodd" === q.toLowerCase() ? k.setFillType(a.FillType.EvenOdd) : k.setFillType(a.FillType.Winding);
                this.de.clipPath(k, a.ClipOp.Intersect, true);
                k.delete();
              };
              ...
              this.drawImage = function(k) {
                k instanceof J && (k = k.Mf());
                var q = this.kf();
                if (3 === arguments.length || 5 === arguments.length) var z = a.XYWHRect(arguments[1], arguments[2], arguments[3] || k.width(), arguments[4] || k.height()), B = a.XYWHRect(0, 0, k.width(), k.height());
                ...
                this.de.drawImageRect(k, B, z, q, false);
                q.dispose();
              };
              this.ellipse = function(k, q, z, B, F, H, O, Z) {
                D(this.ie, k, q, z, B, F, H, O, Z);
              };
              this.kf = function() {
                var k = this.ge.copy();
                k.setStyle(a.PaintStyle.Fill);
                if (f(this.te)) {
                  var q = a.multiplyByAlpha(this.te, this.Ce);
                  k.setColor(q);
                } else q = this.te.Ne(this.le), k.setColor(a.Color(0, 0, 0, this.Ce)), k.setShader(q);
                k.dispose = function() {
                  this.delete();
                };
                return k;
              ...
              this.fill = function(k, q) {
                "string" === typeof k ? (q = k, k = this.ie) : k && k.wf && (k = k.me);
                if ("evenodd" === q) this.ie.setFillType(a.FillType.EvenOdd);
                else {
                  if ("nonzero" !== q && q) throw "invalid fill rule";
                  this.ie.setFillType(a.FillType.Winding);
                }
                k || (k = this.ie);
                q = this.kf();
                var z = this.Se(q);
                z && (this.de.save(), this.Le(), this.de.drawPath(k, z), this.de.restore(), z.dispose());
                this.de.drawPath(k, q);
                q.dispose();
              };
              this.fillRect = function(k, q, z, B) {
                var F = this.kf(), H = this.Se(F);
                H && (this.de.save(), this.Le(), this.de.drawRect(a.XYWHRect(k, q, z, B), H), this.de.restore(), H.dispose());
                this.de.drawRect(a.XYWHRect(k, q, z, B), F);
                F.dispose();
              };
              this.fillText = function(k, q, z) {
                var B = this.kf();
                k = a.TextBlob.MakeFromText(k, this.Ge);
                var F = this.Se(B);
                F && (this.de.save(), this.Le(), this.de.drawTextBlob(k, q, z, F), this.de.restore(), F.dispose());
                this.de.drawTextBlob(k, q, z, B);
                k.delete();
                B.dispose();
              };
              this.getImageData = function(k, q, z, B) {
                return (k = this.de.readPixels(k, q, { width: z, height: B, colorType: a.ColorType.RGBA_8888, alphaType: a.AlphaType.Unpremul, colorSpace: a.ColorSpace.SRGB })) ? new N(new Uint8ClampedArray(k.buffer), z, B) : null;
              };
              this.getLineDash = function() {
                return this.Oe.slice();
              };
              this.Hf = function(k) {
                var q = a.Matrix.invert(this.le);
                a.Matrix.mapPoints(q, k);
                return k;
              };
              this.isPointInPath = function(k, q, z) {
                var B = arguments;
                if (3 === B.length) var F = this.ie;
              ...
              this.isPointInStroke = function(k, q) {
                ...
                B.stroke({ width: this.lineWidth, miter_limit: this.miterLimit, cap: this.ge.getStrokeCap(), join: this.ge.getStrokeJoin(), precision: 0.3 });
                z = B.contains(k, q);
                B.delete();
                return z;
              };
              ...
              this.measureText = function(k) {
                k = this.Ge.getGlyphIDs(k);
                k = this.Ge.getGlyphWidths(k);
                let q = 0;
              ...
              this.putImageData = function(k, q, z, B, F, H, O) {
                if (e([q, z, B, F, H, O])) {
                  if (void 0 === B) this.de.writePixels(k.data, k.width, k.height, q, z);
                  else if (B = B || 0, F = F || 0, H = H || k.width, O = O || k.height, 0 > H && (B += H, H = Math.abs(H)), 0 > O && (F += O, O = Math.abs(O)), 0 > B && (H += B, B = 0), 0 > F && (O += F, F = 0), !(0 >= H || 0 >= O)) {
                    ...
                    z = a.Matrix.invert(this.le);
                    this.de.save();
                    this.de.concat(z);
                    this.de.drawImageRect(k, Z, q, null, false);
                    this.de.restore();
                    k.delete();
                  }
                }
              ...
              this.resetTransform = function() {
                this.ie.transform(this.le);
                var k = a.Matrix.invert(this.le);
                this.de.concat(k);
                this.le = this.de.getTotalMatrix();
              };
              this.restore = function() {
                var k = this.Gf.pop();
                if (k) {
                  var q = a.Matrix.multiply(this.le, a.Matrix.invert(k.ag));
                  this.ie.transform(q);
                  this.ge.delete();
                  this.ge = k.tg;
                  this.Oe = k.rg;
              ...
              this.rotate = function(k) {
                if (isFinite(k)) {
                  ...
                  this.ie.transform(q);
                  this.de.rotate(k / Math.PI * 180, 0, 0);
                  this.le = this.de.getTotalMatrix();
                }
              };
              this.save = function() {
                ...
                this.Gf.push({ ag: this.le.slice(), rg: this.Oe.slice(), Fg: this.cf, Eg: q, fs: k, Cg: this.Qe, Dg: this.Re, sb: this.Pe, Bg: this.bf, ga: this.Ce, sg: this.af, ig: this.fe, tg: this.ge.copy(), hg: this.lf });
                this.de.save();
              };
              ...
              this.Le = function() {
                var k = a.Matrix.invert(this.le);
                this.de.concat(k);
                this.de.concat(a.Matrix.translated(this.Qe, this.Re));
                this.de.concat(this.le);
              };
              this.Se = function(k) {
                var q = a.multiplyByAlpha(this.bf, this.Ce);
                if (!a.getColorComponents(q)[3] || !(this.Pe || this.Re || this.Qe)) return null;
                k = k.copy();
                k.setColor(q);
                var z = a.MaskFilter.MakeBlur(a.BlurStyle.Normal, this.Pe / 2, false);
                k.setMaskFilter(z);
                k.dispose = function() {
                  z.delete();
                  this.delete();
              ...
              this.yf = function() {
                ...
                if (f(this.ze)) {
                  var q = a.multiplyByAlpha(this.ze, this.Ce);
                  k.setColor(q);
                } else q = this.ze.Ne(this.le), k.setColor(a.Color(0, 0, 0, this.Ce)), k.setShader(q);
                k.setStrokeWidth(this.cf);
                if (this.Oe.length) {
                  var z = a.PathEffect.MakeDash(this.Oe, this.af);
                  k.setPathEffect(z);
                }
                k.dispose = function() {
                  z && z.delete();
              ...
              this.stroke = function(k) {
                k = k ? k.me : this.ie;
                var q = this.yf(), z = this.Se(q);
                z && (this.de.save(), this.Le(), this.de.drawPath(k, z), this.de.restore(), z.dispose());
                this.de.drawPath(k, q);
                q.dispose();
              };
              this.strokeRect = function(k, q, z, B) {
                var F = this.yf(), H = this.Se(F);
                H && (this.de.save(), this.Le(), this.de.drawRect(a.XYWHRect(k, q, z, B), H), this.de.restore(), H.dispose());
                this.de.drawRect(a.XYWHRect(k, q, z, B), F);
                F.dispose();
              };
            ...
            function C(I) {
              ...
              this.getContext = function(k) {
                return "2d" === k ? this.ce : null;
              };
              this.toDataURL = function(k, q) {
                this.zf.flush();
                var z = this.zf.makeImageSnapshot();
                if (z) {
                  k = k || "image/png";
                  ...
                  if (q = z.encodeToBytes(B, q || 0.92)) {
                    ...
                    if ("undefined" !== typeof Buffer) q = Buffer.from(q).toString("base64");
                      ...
                      z = 0;
                      B = q.length;
                      for (var F = "", H; z < B; ) H = q.slice(z, Math.min(z + 32768, B)), F += String.fromCharCode.apply(null, H), z += 32768;
                      q = btoa(F);
                    }
                    return k + q;
                  }
            ...
            function P(I, k, q, z) {
              ...
              this.addColorStop = function(B, F) {
                ...
                F = g(F);
                var H = this.re.indexOf(B);
                if (-1 !== H) this.ve[H] = F;
                else {
                  for (H = 0; H < this.re.length && !(this.re[H] > B); H++) ;
                  this.re.splice(H, 0, B);
                  this.ve.splice(H, 0, F);
                }
              };
              this.Me = function() {
                var B = new P(I, k, q, z);
              ...
              this.Fe = function() {
                this.oe && (this.oe.delete(), this.oe = null);
              };
              this.Ne = function(B) {
                var F = [I, k, q, z];
                ...
                F = F[3];
                this.Fe();
                return this.oe = a.Shader.MakeLinearGradient([B, H], [O, F], this.ve, this.re, a.TileMode.Clamp);
              };
            }
            ...
            function t(I, k, q, z, B, F, H) {
              ...
              1e-5 > Math.abs(Math.abs(H) - 360) ? (q = H / 2, I.arcToOval(k, F, q, false), I.arcToOval(k, F + q, q, false)) : I.arcToOval(k, F, H, false);
            }
            function D(I, k, q, z, B, F, H, O, Z) {
              if (e([k, q, z, B, F, H, O])) {
                if (0 > z || 0 > B) throw "radii cannot be negative";
                var qa = 2 * Math.PI, db = H % qa;
                0 > db && (db += qa);
                var eb = db - H;
                H = db;
                O += eb;
                !Z && O - H >= qa ? O = H + qa : Z && H - O >= qa ? O = H - qa : !Z && H > O ? O = H + (qa - (H - O) % qa) : Z && H < O && (O = H - (qa - (O - H) % qa));
                F ? (Z = a.Matrix.rotated(F, k, q), F = a.Matrix.rotated(-F, k, q), I.transform(F), t(I, k, q, z, B, H, O), I.transform(Z)) : t(I, k, q, z, B, H, O);
              }
            }
            function U(I, k, q) {
            ...
            function fa(I) {
              this.me = null;
              this.me = "string" === typeof I ? a.Path.MakeFromSVGString(I) : I && I.wf ? I.me.copy() : new a.Path();
              this.wf = function() {
                return this.me;
              };
              this.addPath = function(k, q) {
                q || (q = { a: 1, c: 0, e: 0, b: 0, d: 1, f: 0 });
                this.me.addPath(k.me, [
                  q.a,
                  q.c,
                  q.e,
                  q.b,
            ...
            function la(I, k) {
              ...
              switch (k) {
                ...
                case "repeat-y":
                  ...
                  break;
                case "repeat":
                  this.Ue = this.Te = a.TileMode.Repeat;
                  break;
                case "no-repeat":
                  this.Ue = this.Te = a.TileMode.Decal;
                  break;
                default:
              ...
              this.Ne = function() {
                this.Fe();
                return this.oe = this.Vf.makeShaderCubic(this.Te, this.Ue, 1 / 3, 1 / 3, this._transform);
              };
            }
            function ua(I, k, q, z, B, F) {
              ...
              this.addColorStop = function(H, O) {
                ...
                O = g(O);
                var Z = this.re.indexOf(H);
                if (-1 !== Z) this.ve[Z] = O;
                else {
                  for (Z = 0; Z < this.re.length && !(this.re[Z] > H); Z++) ;
                  this.re.splice(Z, 0, H);
                  this.ve.splice(Z, 0, O);
                }
              };
              this.Me = function() {
              ...
              this.Ne = function(H) {
                ...
                var Z = O[0], qa = O[1], db = O[2];
                O = O[3];
                var eb = (Math.abs(H[0]) + Math.abs(H[4])) / 2;
                H = q * eb;
                eb *= F;
                this.Fe();
                return this.oe = a.Shader.MakeTwoPointConicalGradient([Z, qa], H, [db, O], eb, this.ve, this.re, a.TileMode.Clamp);
              };
            }
            a._testing = {};
            var ya = {
              ...
              lightgoldenrodyellow: Float32Array.of(
                0.98,
                0.98,
                0.824,
                1
              ...
              mediumspringgreen: Float32Array.of(
                0,
                0.98,
                0.604,
                1
            ...
            var Fa = RegExp("(italic|oblique|normal|)\\s*(small-caps|normal|)\\s*(bold|bolder|lighter|[1-9]00|normal|)\\s*([\\d\\.]+)(px|pt|pc|in|cm|mm|%|em|ex|ch|rem|q)(.+)"), ha;
            a._testing.parseFontString = l;
            a.MakeCanvas = function(I, k) {
              return (I = a.MakeSurface(
                I,
                k
              )) ? new C(I) : null;
            };
            a.ImageData = function() {
              ...
              if (3 === arguments.length) {
                var q = arguments[0];
                if (q.prototype.constructor !== Uint8ClampedArray) throw new TypeError("bytes must be given as a Uint8ClampedArray");
                I = arguments[1];
                k = arguments[2];
        ...
        var oa = Object.assign({}, w), ra = "./this.program", va = (a, b) => {
          throw b;
        }, wa = "object" == typeof window, xa = "function" == typeof importScripts, za = "object" == typeof process && "object" == typeof process.versions && "string" == typeof process.versions.node, Aa = "", Ba, Ca, Da;
        if (za) {
          var fs = require_fs(), Ea = require_path();
        ...
        } else if (wa || xa) xa ? Aa = self.location.href : "undefined" != typeof document && document.currentScript && (Aa = document.currentScript.src), _scriptDir && (Aa = _scriptDir), 0 !== Aa.indexOf("blob:") ? Aa = Aa.substr(0, Aa.replace(/[?#].*/, "").lastIndexOf("/") + 1) : Aa = "", Ba = (a) => {
        ...
        var Ga = w.print || console.log.bind(console), Ha = w.printErr || console.error.bind(console);
        Object.assign(w, oa);
        oa = null;
        ...
        var La, Ma, Na = false, Qa, K, Ra, Sa, Q, Ta, S, Ua;
        function Va() {
          var a = La.buffer;
        ...
        if (!hb(ib)) {
          var nb = ib;
          ib = w.locateFile ? w.locateFile(nb, Aa) : Aa + nb;
        }
        function ob(a) {
        ...
        function qb(a, b, d) {
          return pb(a).then((f) => WebAssembly.instantiate(f, b)).then((f) => f).then(d, (f) => {
        ...
        function rb(a, b) {
          var d = ib;
          return Ia || "function" != typeof WebAssembly.instantiateStreaming || hb(d) || d.startsWith("file://") || za || "function" != typeof fetch ? qb(d, a, b) : fetch(d, { credentials: "same-origin" }).then((f) => WebAssembly.instantiateStreaming(f, a).then(b, function(h) {
        ...
        }, ub = "undefined" != typeof TextDecoder ? new TextDecoder("utf8") : void 0, vb = (a, b, d) => {
          var f = b + d;
          for (d = b; a[d] && !(d >= f); ) ++d;
        ...
        function Nb(a) {
          Lb(a.be.ne.he.name + " instance already deleted");
        }
        var Ob = false;
        function Pb() {
        }
        function Qb(a) {
          --a.count.value;
          0 === a.count.value && (a.qe ? a.xe.Ee(a.qe) : a.ne.he.Ee(a.je));
        }
        function Rb(a, b, d) {
          if (b === d) return a;
          if (void 0 === d.se) return null;
          a = Rb(a, b, d.se);
          return null === a ? null : d.eg(a);
        }
        var Sb = {}, Tb = [];
        function Ub() {
          for (; Tb.length; ) {
        ...
        var Vb = void 0, Wb = {};
        function Xb(a, b) {
          for (void 0 === b && Lb("ptr should not be undefined"); a.se; ) b = a.hf(b), a = a.se;
          return Wb[b];
        }
        function dc(a, b) {
          b.ne && b.je || Eb("makeClassHandle requires ptr and ptrType");
          !!b.xe !== !!b.qe && Eb("Both smartPtrType and smartPtr must be specified");
          b.count = { value: 1 };
          return ec(Object.create(a, { be: { value: b } }));
        }
        function ec(a) {
        ...
        function ic(a, b, d) {
          if (void 0 === a[b].pe) {
            var f = a[b];
            a[b] = function() {
              a[b].pe.hasOwnProperty(arguments.length) || Lb(`Function '${d}' called with an invalid number of arguments (${arguments.length}) - expects one of (${a[b].pe})!`);
              return a[b].pe[arguments.length].apply(this, arguments);
            };
            a[b].pe = [];
            a[b].pe[f.We] = f;
          }
        ...
        function jc(a, b, d) {
          w.hasOwnProperty(a) ? ((void 0 === d || void 0 !== w[a].pe && void 0 !== w[a].pe[d]) && Lb(`Cannot register public name '${a}' twice`), ic(w, a, a), w.hasOwnProperty(d) && Lb(`Cannot register multiple overloads of a function with the same number of arguments (${d})!`), w[a].pe[d] = b) : (w[a] = b, void 0 !== d && (w[a].Pg = d));
        }
        ...
        function lc(a, b, d) {
          for (; b !== d; ) b.hf || Lb(`Expected null or instance of ${d.name}, got an instance of ${b.name}`), a = b.hf(a), b = b.se;
          return a;
        }
        function mc(a, b) {
          if (null === b) return this.Cf && Lb(`null is not a valid ${this.name}`), 0;
          b.be || Lb(`Cannot pass "${nc(b)}" as a ${this.name}`);
          b.be.je || Lb(`Cannot pass deleted object as a pointer of type ${this.name}`);
          return lc(b.be.je, b.be.ne.he, this.he);
        }
        function oc(a, b) {
          if (null === b) {
            this.Cf && Lb(`null is not a valid ${this.name}`);
            if (this.qf) {
              var d = this.Df();
              null !== a && a.push(this.Ee, d);
              return d;
            }
            return 0;
          }
          b.be || Lb(`Cannot pass "${nc(b)}" as a ${this.name}`);
          b.be.je || Lb(`Cannot pass deleted object as a pointer of type ${this.name}`);
          !this.pf && b.be.ne.pf && Lb(`Cannot convert argument of type ${b.be.xe ? b.be.xe.name : b.be.ne.name} to parameter type ${this.name}`);
          d = lc(b.be.je, b.be.ne.he, this.he);
          if (this.qf) switch (void 0 === b.be.qe && Lb("Passing raw pointer to smart pointer is illegal"), this.Ag) {
            case 0:
              b.be.xe === this ? d = b.be.qe : Lb(`Cannot convert argument of type ${b.be.xe ? b.be.xe.name : b.be.ne.name} to parameter type ${this.name}`);
              break;
            case 1:
              d = b.be.qe;
              break;
            case 2:
              if (b.be.xe === this) d = b.be.qe;
              else {
                var f = b.clone();
                d = this.wg(d, pc(function() {
                  f["delete"]();
                }));
                null !== a && a.push(this.Ee, d);
              }
        ...
        function qc(a, b) {
          ...
          b.be || Lb(`Cannot pass "${nc(b)}" as a ${this.name}`);
          b.be.je || Lb(`Cannot pass deleted object as a pointer of type ${this.name}`);
          b.be.ne.pf && Lb(`Cannot convert argument of type ${b.be.ne.name} to parameter type ${this.name}`);
          return lc(b.be.je, b.be.ne.he, this.he);
        }
        function rc(a, b, d, f, h, m, u, n, p, v, E) {
          ...
          this.wg = v;
          this.Ee = E;
          h || void 0 !== b.se ? this.toWireType = oc : (this.toWireType = f ? mc : qc, this.we = null);
        }
        function sc(a, b, d) {
          w.hasOwnProperty(a) || Eb("Replacing nonexistant public symbol");
          void 0 !== w[a].pe && void 0 !== d ? w[a].pe[d] = b : (w[a] = b, w[a].We = d);
        }
        var tc = (a, b) => {
          var d = [];
          return function() {
        ...
        function zc(a, b) {
          function d(m) {
            h[m] || Ab[m] || (Cb[m] ? Cb[m].forEach(d) : (f.push(m), h[m] = true));
          }
          var f = [], h = {};
          b.forEach(d);
        ...
        function Fc(a, b, d, f, h) {
          ...
          for (d = 1; d < b.length; ++d) if (null !== b[d] && void 0 === b[d].we) {
            n = true;
            break;
          }
          var p = "void" !== b[0].name, v = m - 2, E = Array(v), G = [], L = [];
          return function() {
        ...
        var na = (a, b, d, f) => {
          ...
          return b;
        }, Pc = "undefined" != typeof TextDecoder ? new TextDecoder("utf-16le") : void 0, Qc = (a, b) => {
          var d = a >> 1;
        ...
        var hd = 1, jd = [], kd = [], ld = [], md = [], da = [], nd = [], od = [], ka = [], pd = [], qd = [], rd = [], sd = {}, td = {}, ud = 4;
        function vd(a) {
          wd || (wd = a);
        }
        function ca(a) {
        ...
        function ia(a, b) {
          a.ef || (a.ef = a.getContext, a.getContext = function(f, h) {
            h = a.ef(f, h);
        ...
        function xd(a, b) {
          var d = ca(ka), f = { handle: d, attributes: b, version: b.majorVersion, ye: a };
          a.canvas && (a.canvas.Sf = f);
          ka[d] = f;
          ("undefined" == typeof b.fg || b.fg) && yd(f);
          return d;
        }
        function ja(a) {
          A = ka[a];
        ...
        function yd(a) {
          ...
          if (!a.pg) {
            ...
            fd(b);
            gd(b);
            b.Jf = b.getExtension("WEBGL_draw_instanced_base_vertex_base_instance");
            b.Nf = b.getExtension("WEBGL_multi_draw_instanced_base_vertex_base_instance");
            ...
            b.Og = b.getExtension("WEBGL_multi_draw");
        ...
        function Jd(a, b, d, f) {
          for (var h = 0; h < a; h++) {
            var m = X[d](), u = m && ca(f);
            m ? (m.name = u, f[u] = m) : vd(1282);
            Q[b + 4 * h >> 2] = u;
          }
        }
        function Kd(a, b) {
          Jd(a, b, "createVertexArray", od);
        }
        function Ld(a, b) {
          Ta[a >> 2] = b;
        ...
        function Md(a, b, d) {
          if (b) {
            ...
            if (void 0 === f) switch (h = X.getParameter(a), typeof h) {
              case "number":
                f = h;
                break;
              case "boolean":
              ...
              case "object":
                if (null === h) switch (a) {
                  ...
                  try {
                    ...
                    vd(1280);
                    Ha("GL_INVALID_ENUM in glGet" + d + "v: Unknown object returned from WebGL getParameter(" + a + ")! (error: " + m + ")");
                    return;
                  }
                }
                break;
              default:
                vd(1280);
                Ha("GL_INVALID_ENUM in glGet" + d + "v: Native code calling glGet" + d + "v(" + a + ") and it returns " + h + " of type " + typeof h + "!");
                return;
            }
            switch (d) {
              case 1:
        ...
        function Od(a, b, d) {
          if (d) {
            a = pd[a];
            b = 2 > A.version ? X.Ae.getQueryObjectEXT(a, b) : X.getQueryParameter(a, b);
            var f;
        ...
        function Sd(a, b) {
          if (2 > A.version) return vd(1282), 0;
          var d = td[a];
          if (d) return 0 > b || b >= d.length ? (vd(1281), 0) : d[b];
          switch (a) {
            case 7939:
              return d = X.getSupportedExtensions() || [], d = d.concat(d.map(function(f) {
                return "GL_" + f;
              })), d = d.map(function(f) {
                return Qd(f);
              }), d = td[a] = d, 0 > b || b >= d.length ? (vd(1281), 0) : d[b];
            default:
              return vd(1280), 0;
          }
        }
        ...
        function Ud(a) {
          a -= 5120;
          return 0 == a ? Qa : 1 == a ? K : 2 == a ? Ra : 4 == a ? Q : 6 == a ? S : 5 == a || 28922 == a || 28520 == a || 30779 == a || 30782 == a ? Ta : Sa;
        }
        function Vd(a, b, d, f, h) {
          a = Ud(a);
          var m = 31 - Math.clz32(a.BYTES_PER_ELEMENT), u = ud;
        ...
        function Wd(a) {
          ...
          if (b) {
            var d = b.gf[a];
            "number" == typeof d && (b.gf[a] = d = X.getUniformLocation(b, b.Qf[a] + (0 < d ? "[" + d + "]" : "")));
            return d;
          }
          vd(1282);
        }
        var Xd = [], Yd = [], Zd = {}, ae = () => {
          ...
          return $d;
        }, $d, be = [null, [], []], ce = (a) => 0 === a % 4 && (0 !== a % 100 || 0 === a % 400), de = [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], ee = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
        function fe(a) {
          var b = Array(ma(a) + 1);
          na(a, b, 0, b.length);
          return b;
        ...
        var ge = (a, b, d, f) => {
          ...
          function u(y, M) {
            ...
            var R;
            0 === (R = T(y.getFullYear() - M.getFullYear())) && 0 === (R = T(y.getMonth() - M.getMonth())) && (R = T(y.getDate() - M.getDate()));
            return R;
          }
          function n(y) {
            switch (y.getDay()) {
          ...
          function p(y) {
            var M = y.Ie;
            for (y = new Date(new Date(y.Je + 1900, 0, 1).getTime()); 0 < M; ) {
              var T = y.getMonth(), R = (ce(y.getFullYear()) ? de : ee)[T];
              if (M > R - y.getDate()) M -= R - y.getDate() + 1, y.setDate(1), 11 > T ? y.setMonth(T + 1) : (y.setMonth(0), y.setFullYear(y.getFullYear() + 1));
              else {
          ...
          var v = Q[f + 40 >> 2];
          f = { Ig: Q[f >> 2], Hg: Q[f + 4 >> 2], uf: Q[f + 8 >> 2], Ef: Q[f + 12 >> 2], vf: Q[f + 16 >> 2], Je: Q[f + 20 >> 2], Be: Q[f + 24 >> 2], Ie: Q[f + 28 >> 2], Rg: Q[f + 32 >> 2], Gg: Q[f + 36 >> 2], Jg: v ? v ? vb(K, v) : "" : "" };
          d = d ? vb(K, d) : "";
          v = {
            "%c": "%a %b %d %H:%M:%S %Y",
            "%D": "%m/%d/%y",
          ...
          v = { "%a": (y) => G[y.Be].substring(0, 3), "%A": (y) => G[y.Be], "%b": (y) => L[y.vf].substring(0, 3), "%B": (y) => L[y.vf], "%C": (y) => m((y.Je + 1900) / 100 | 0, 2), "%d": (y) => m(y.Ef, 2), "%e": (y) => h(y.Ef, 2, " "), "%g": (y) => p(y).toString().substring(2), "%G": (y) => p(y), "%H": (y) => m(y.uf, 2), "%I": (y) => {
            y = y.uf;
            0 == y ? y = 12 : 12 < y && (y -= 12);
            return m(y, 2);
          }, "%j": (y) => {
            for (var M = 0, T = 0; T <= y.vf - 1; M += (ce(y.Je + 1900) ? de : ee)[T++]) ;
            return m(y.Ef + M, 3);
          }, "%m": (y) => m(y.vf + 1, 2), "%M": (y) => m(y.Hg, 2), "%n": () => "\n", "%p": (y) => 0 <= y.uf && 12 > y.uf ? "AM" : "PM", "%S": (y) => m(y.Ig, 2), "%t": () => "	", "%u": (y) => y.Be || 7, "%U": (y) => m(Math.floor((y.Ie + 7 - y.Be) / 7), 2), "%V": (y) => {
            var M = Math.floor((y.Ie + 7 - (y.Be + 6) % 7) / 7);
            2 >= (y.Be + 371 - y.Ie - 2) % 7 && M++;
            if (M) 53 == M && (T = (y.Be + 371 - y.Ie) % 7, 4 == T || 3 == T && ce(y.Je) || (M = 1));
            else {
              M = 52;
              var T = (y.Be + 7 - y.Ie - 1) % 7;
              (4 == T || 5 == T && ce(y.Je % 400 - 1)) && M++;
            }
            return m(M, 2);
          }, "%w": (y) => y.Be, "%W": (y) => m(Math.floor((y.Ie + 7 - (y.Be + 6) % 7) / 7), 2), "%y": (y) => (y.Je + 1900).toString().substring(2), "%Y": (y) => y.Je + 1900, "%z": (y) => {
            y = y.Gg;
            var M = 0 <= y;
            y = Math.abs(y) / 60;
        ...
        for (var he = Array(256), ie = 0; 256 > ie; ++ie) he[ie] = String.fromCharCode(ie);
        Ib = he;
        ...
        fc.prototype.isAliasOf = function(a) {
          if (!(this instanceof fc && a instanceof fc)) return false;
          var b = this.be.ne.he, d = this.be.je, f = a.be.ne.he;
          for (a = a.be.je; b.se; ) d = b.hf(d), b = b.se;
          for (; f.se; ) a = f.hf(a), f = f.se;
          return b === f && d === a;
        };
        fc.prototype.clone = function() {
          this.be.je || Nb(this);
          if (this.be.ff) return this.be.count.value += 1, this;
          var a = ec, b = Object, d = b.create, f = Object.getPrototypeOf(this), h = this.be;
          a = a(d.call(b, f, { be: { value: { count: h.count, Ye: h.Ye, ff: h.ff, je: h.je, ne: h.ne, qe: h.qe, xe: h.xe } } }));
          a.be.count.value += 1;
          a.be.Ye = false;
          return a;
        };
        fc.prototype["delete"] = function() {
          this.be.je || Nb(this);
          this.be.Ye && !this.be.ff && Lb("Object already scheduled for deletion");
          Pb(this);
          Qb(this.be);
          this.be.ff || (this.be.qe = void 0, this.be.je = void 0);
        };
        ...
        rc.prototype.kg = function(a) {
          this.Of && (a = this.Of(a));
          return a;
        };
        rc.prototype.If = function(a) {
          this.Ee && this.Ee(a);
        };
        ...
        rc.prototype.fromWireType = function(a) {
          function b() {
            return this.qf ? dc(this.he.Ze, { ne: this.ug, je: d, xe: this, qe: a }) : dc(this.he.Ze, { ne: this, je: a });
          }
          var d = this.kg(a);
          if (!d) return this.If(a), null;
          var f = Xb(this.he, d);
          if (void 0 !== f) {
            if (0 === f.be.count.value) return f.be.je = d, f.be.qe = a, f.clone();
            f = f.clone();
            this.If(a);
            return f;
          }
          ...
          f = this.pf ? f.$f : f.pointerType;
          var h = Rb(d, this.he, f.he);
          return null === h ? b.call(this) : this.qf ? dc(f.he.Ze, { ne: f, je: h, xe: this, qe: a }) : dc(
            f.he.Ze,
            { ne: f, je: h }
          );
        };
        ...
        Object.assign(Hc.prototype, { get(a) {
          return this.De[a];
        }, has(a) {
          return void 0 !== this.De[a];
        }, Zf(a) {
          var b = this.Lf.pop() || this.De.length;
          this.De[b] = a;
          return b;
        }, cg(a) {
          this.De[a] = void 0;
        ...
        Ic.De.push({ value: void 0 }, { value: null }, { value: true }, { value: false });
        Ic.ef = Ic.De.length;
        w.count_emval_handles = function() {
          for (var a = 0, b = Ic.ef; b < Ic.De.length; ++b) void 0 !== Ic.De[b] && ++a;
          return a;
        };
        for (var X, je = 0; 32 > je; ++je) Fd.push(Array(je));
        ...
        var De = {
          ...
          E: function(a) {
            var b = wb[a];
            delete wb[a];
            var d = b.Df, f = b.Ee, h = b.Kf, m = h.map((u) => u.ng).concat(h.map((u) => u.yg));
            Fb([a], m, (u) => {
              var n = {};
              h.forEach((p, v) => {
                var E = u[v], G = p.lg, L = p.mg, y = u[v + h.length], M = p.xg, T = p.zg;
                n[p.gg] = { read: (R) => E.fromWireType(G(L, R)), write: (R, ta) => {
                  var pa = [];
              ...
              return [{ name: b.name, fromWireType: function(p) {
                ...
                null !== p && p.push(f, G);
                return G;
              }, argPackAdvance: 8, readValueFromPointer: yb, we: f }];
            });
          },
          ob: function() {
          },
          Db: function(a, b, d, f, h) {
            var m = Hb(d);
            b = Jb(b);
            Gb(a, { name: b, fromWireType: function(u) {
              return !!u;
          ...
          o: function(a, b, d, f, h, m, u, n, p, v, E, G, L) {
            ...
            Fb([a, b, d], f ? [f] : [], function(M) {
              ...
              M = hc(y, function() {
                ...
                if (void 0 === pa.He) throw new Kb(E + " has no accessible constructor");
                var kb = pa.He[arguments.length];
                if (void 0 === kb) throw new Kb(`Tried to invoke ctor of ${E} with invalid number of parameters (${arguments.length}) - expected (${Object.keys(pa.He).toString()}) parameters instead!`);
                return kb.apply(this, arguments);
              });
              var ta = Object.create(R, { constructor: { value: M } });
              M.prototype = ta;
              var pa = new kc(E, M, ta, L, T, m, n, v);
              pa.se && (void 0 === pa.se.jf && (pa.se.jf = []), pa.se.jf.push(pa));
              T = new rc(E, pa, true, false, false);
              R = new rc(E + "*", pa, false, false, false);
              var jb = new rc(E + " const*", pa, false, true, false);
              Sb[a] = { pointerType: R, $f: jb };
              sc(y, M);
              return [
                T,
                R,
          ...
          i: function(a, b, d, f, h, m, u) {
            ...
            Fb([], [a], function(p) {
              ...
              var G = p.he.constructor;
              void 0 === G[b] ? (v.We = d - 1, G[b] = v) : (ic(G, b, E), G[b].pe[d - 1] = v);
              Fb([], n, function(L) {
                L = [L[0], null].concat(L.slice(1));
                L = Fc(E, L, null, m, u);
                void 0 === G[b].pe ? (L.We = d - 1, G[b] = L) : G[b].pe[d - 1] = L;
                if (p.he.jf) for (const y of p.he.jf) y.constructor.hasOwnProperty(b) || (y.constructor[b] = L);
                return [];
              });
              return [];
            });
          ...
          G: function(a, b, d, f, h, m) {
            ...
            Fb([], [a], function(n) {
              ...
              void 0 === n.he.He && (n.he.He = []);
              if (void 0 !== n.he.He[b - 1]) throw new Kb(`Cannot register multiple constructors with identical number of parameters (${b - 1}) for class '${n.name}'! Overload resolution is currently only performed using the parameter count, not actual type info!`);
              n.he.He[b - 1] = () => {
          ...
          b: function(a, b, d, f, h, m, u, n) {
            ...
            Fb([], [a], function(v) {
              ...
              n && v.he.vg.push(b);
              var L = v.he.Ze, y = L[b];
              void 0 === y || void 0 === y.pe && y.className !== v.name && y.We === d - 2 ? (E.We = d - 2, E.className = v.name, L[b] = E) : (ic(L, b, G), L[b].pe[d - 2] = E);
              Fb([], p, function(M) {
                M = Fc(G, M, v, m, u);
                void 0 === L[b].pe ? (M.We = d - 2, L[b] = M) : L[b].pe[d - 2] = M;
                return [];
              });
              return [];
            });
          ...
          Cb: function(a, b) {
            b = Jb(b);
            Gb(a, { name: b, fromWireType: function(d) {
              var f = Kc(d);
              Jc(d);
              return f;
            }, toWireType: function(d, f) {
              return pc(f);
            }, argPackAdvance: 8, readValueFromPointer: yb, we: null });
          },
          m: function(a, b, d, f) {
            function h() {
            }
          ...
          d: function(a, b, d) {
            ...
            b = Jb(b);
            a = f.constructor;
            f = Object.create(f.constructor.prototype, { value: { value: d }, constructor: { value: hc(`${f.name}_${b}`, function() {
            }) } });
            a.values[d] = f;
            a[b] = f;
          },
          V: function(a, b, d) {
            d = Hb(d);
            b = Jb(b);
            Gb(a, { name: b, fromWireType: function(f) {
              return f;
            }, toWireType: function(f, h) {
              return h;
            }, argPackAdvance: 8, readValueFromPointer: Nc(b, d), we: null });
          },
          ...
          I: function(a, b, d, f, h) {
            ...
            d = b.includes("unsigned") ? function(n, p) {
              return p >>> 0;
            } : function(n, p) {
              return p;
            };
            Gb(a, { name: b, fromWireType: m, toWireType: d, argPackAdvance: 8, readValueFromPointer: Oc(b, h, 0 !== f), we: null });
          },
          v: function(a, b, d) {
            function f(m) {
              m >>= 2;
            ...
            d = Jb(d);
            Gb(a, { name: d, fromWireType: f, argPackAdvance: 8, readValueFromPointer: f }, { og: true });
          },
          s: function(a, b, d, f, h, m, u, n, p, v, E, G) {
            ...
            Fb([a], [b], function(L) {
              L = L[0];
              return [new rc(d, L.he, false, false, true, L, f, m, n, v, G)];
            });
          },
          U: function(a, b) {
            b = Jb(b);
            ...
            Gb(a, { name: b, fromWireType: function(f) {
              ...
              m || h instanceof Uint8Array || h instanceof Uint8ClampedArray || h instanceof Int8Array || Lb("Cannot pass non-string to std::string");
              var u = d && m ? ma(h) : h.length;
              var n = Pd(4 + u + 1), p = n + 4;
              Ta[n >> 2] = u;
              if (d && m) na(h, K, p, u + 1);
              ...
              null !== f && f.push(yc, n);
              return n;
            }, argPackAdvance: 8, readValueFromPointer: yb, we: function(f) {
              yc(f);
            } });
          },
          P: function(a, b, d) {
            ...
            Gb(a, { name: d, fromWireType: function(p) {
              for (var v = Ta[p >> 2], E = u(), G, L = p + 4, y = 0; y <= v; ++y) {
                var M = p + 4 + y * b;
                if (y == v || 0 == E[M >> n]) L = f(L, M - L), void 0 === G ? G = L : (G += String.fromCharCode(0), G += L), L = M + b;
              }
              yc(p);
              return G;
            }, toWireType: function(p, v) {
              "string" != typeof v && Lb(`Cannot pass non-string to C++ string type ${d}`);
              var E = m(v), G = Pd(4 + E + b);
              Ta[G >> 2] = E >> n;
              h(v, G + 4, E + b);
              null !== p && p.push(yc, G);
              return G;
            }, argPackAdvance: 8, readValueFromPointer: yb, we: function(p) {
              yc(p);
            } });
          },
          F: function(a, b, d, f, h, m) {
            wb[a] = { name: Jb(b), Df: uc(d, f), Ee: uc(h, m), Kf: [] };
          },
          f: function(a, b, d, f, h, m, u, n, p, v) {
            wb[a].Kf.push({ gg: Jb(b), ng: d, lg: uc(f, h), mg: m, yg: u, xg: uc(n, p), zg: v });
          },
          Eb: function(a, b) {
            b = Jb(b);
            Gb(a, { qg: true, name: b, argPackAdvance: 0, fromWireType: function() {
            }, toWireType: function() {
            } });
          },
          Bb: () => true,
          ...
          p: function(a, b) {
            ...
            var m = Array(a - 1);
            h = $c((u, n, p, v) => {
              for (var E = 0, G = 0; G < a - 1; ++G) m[G] = d[G + 1].readValueFromPointer(v + E), E += d[G + 1].argPackAdvance;
              u = u[n].apply(u, m);
              for (G = 0; G < a - 1; ++G) d[G + 1].dg && d[G + 1].dg(m[G]);
              if (!f.qg) return f.toWireType(p, u);
            });
            return bd[b] = h;
          },
          B: function(a, b) {
          ...
          oc: function(a, b, d, f, h, m, u, n, p, v) {
            X.blitFramebuffer(a, b, d, f, h, m, u, n, p, v);
          },
          aa: function(a, b, d, f) {
            2 <= A.version ? d && b ? X.bufferData(a, K, f, d, b) : X.bufferData(
              a,
              b,
              f
          ...
          ea: Dd,
          lc: function(a, b, d, f) {
            return X.clientWaitSync(rd[a], b, (d >>> 0) + 4294967296 * f);
          },
          fa: function(a, b, d, f) {
            X.colorMask(!!a, !!b, !!d, !!f);
          },
          ...
          ha: function(a, b, d, f, h, m, u, n) {
            2 <= A.version ? X.Xe || !u ? X.compressedTexImage2D(a, b, d, f, h, m, u, n) : X.compressedTexImage2D(
              a,
              b,
              d,
              f,
          ...
          ia: function(a, b, d, f, h, m, u, n, p) {
            2 <= A.version ? X.Xe || !n ? X.compressedTexSubImage2D(a, b, d, f, h, m, u, n, p) : X.compressedTexSubImage2D(a, b, d, f, h, m, u, K, p, n) : X.compressedTexSubImage2D(a, b, d, f, h, m, u, p ? K.subarray(p, p + n) : null);
          },
          nc: function(a, b, d, f, h) {
            X.copyBufferSubData(a, b, d, f, h);
          },
          ja: function(a, b, d, f, h, m, u, n) {
            X.copyTexSubImage2D(a, b, d, f, h, m, u, n);
          },
          ka: function() {
            var a = ca(kd), b = X.createProgram();
            b.name = a;
            b.tf = b.rf = b.sf = 0;
            b.Ff = 1;
            kd[a] = b;
          ...
          na: function(a, b) {
            for (var d = 0; d < a; d++) {
              var f = Q[b + 4 * d >> 2], h = jd[f];
              h && (X.deleteBuffer(h), h.name = 0, jd[f] = null, f == X.Af && (X.Af = 0), f == X.Xe && (X.Xe = 0));
            }
          },
          xc: function(a, b) {
            for (var d = 0; d < a; ++d) {
              var f = Q[b + 4 * d >> 2], h = ld[f];
          ...
          oa: function(a) {
            if (a) {
              var b = kd[a];
              b ? (X.deleteProgram(b), b.name = 0, kd[a] = null) : vd(1281);
            }
          },
          Zb: function(a, b) {
            for (var d = 0; d < a; d++) {
              var f = Q[b + 4 * d >> 2], h = pd[f];
              h && (X.deleteQuery(h), pd[f] = null);
            }
          },
          Tb: function(a, b) {
            for (var d = 0; d < a; d++) {
              var f = Q[b + 4 * d >> 2], h = pd[f];
              h && (X.Ae.deleteQueryEXT(h), pd[f] = null);
            }
          },
          yc: function(a, b) {
            for (var d = 0; d < a; d++) {
          ...
          dc: function(a, b) {
            for (var d = 0; d < a; d++) {
              var f = Q[b + 4 * d >> 2], h = qd[f];
              h && (X.deleteSampler(h), h.name = 0, qd[f] = null);
            }
          },
          pa: function(a) {
            if (a) {
              var b = nd[a];
              b ? (X.deleteShader(b), nd[a] = null) : vd(1281);
            }
          },
          mc: function(a) {
            if (a) {
              var b = rd[a];
              b ? (X.deleteSync(b), b.name = 0, rd[a] = null) : vd(1281);
            }
          },
          qa: function(a, b) {
            for (var d = 0; d < a; d++) {
              var f = Q[b + 4 * d >> 2], h = da[f];
          ...
          Lc: function(a, b, d, f, h) {
            X.Jf.drawArraysInstancedBaseInstanceWEBGL(a, b, d, f, h);
          },
          Jc: function(a, b) {
            for (var d = Fd[a], f = 0; f < a; f++) d[f] = Q[b + 4 * f >> 2];
            X.drawBuffers(d);
          },
          va: Gd,
          ...
          Mc: function(a, b, d, f, h, m, u) {
            X.Jf.drawElementsInstancedBaseVertexBaseInstanceWEBGL(a, b, d, f, h, m, u);
          },
          Dc: function(a, b, d, f, h, m) {
            Gd(a, f, h, m);
          },
          wa: function(a) {
            X.enable(a);
          ...
          ic: function(a, b) {
            return (a = X.fenceSync(a, b)) ? (b = ca(rd), a.name = b, rd[b] = a, b) : 0;
          },
          ya: function() {
            X.finish();
          },
          ...
          Ac: function(a, b, d, f, h) {
            X.framebufferTexture2D(a, b, d, da[f], h);
          },
          Aa: function(a) {
            X.frontFace(a);
          },
          Ba: function(a, b) {
            Jd(a, b, "createBuffer", jd);
          },
          Bc: function(a, b) {
            Jd(a, b, "createFramebuffer", ld);
          },
          $b: function(a, b) {
            Jd(a, b, "createQuery", pd);
          },
          Vb: function(a, b) {
            for (var d = 0; d < a; d++) {
              var f = X.Ae.createQueryEXT();
              if (!f) {
                for (vd(1282); d < a; ) Q[b + 4 * d++ >> 2] = 0;
                break;
              }
              var h = ca(pd);
              f.name = h;
          ...
          Cc: function(a, b) {
            Jd(a, b, "createRenderbuffer", md);
          },
          ec: function(a, b) {
            Jd(a, b, "createSampler", qd);
          },
          Ca: function(a, b) {
            Jd(a, b, "createTexture", da);
          },
          Rc: Kd,
          Vc: Kd,
          qc: function(a) {
          ...
          Da: function(a, b, d) {
            d ? Q[d >> 2] = X.getBufferParameter(a, b) : vd(1281);
          },
          Ea: function() {
            var a = X.getError() || wd;
            wd = 0;
          ...
          Ha: function(a, b, d, f) {
            ...
            b = 0 < b && f ? na(a, K, f, b) : 0;
            d && (Q[d >> 2] = b);
          },
          Ia: function(a, b, d) {
            if (d) if (a >= hd) vd(1281);
            else if (a = kd[a], 35716 == b) a = X.getProgramInfoLog(a), null === a && (a = "(unknown error)"), Q[d >> 2] = a.length + 1;
            else if (35719 == b) {
              if (!a.tf) for (b = 0; b < X.getProgramParameter(a, 35718); ++b) a.tf = Math.max(a.tf, X.getActiveUniform(a, b).name.length + 1);
              Q[d >> 2] = a.tf;
            } else if (35722 == b) {
              if (!a.rf) for (b = 0; b < X.getProgramParameter(a, 35721); ++b) a.rf = Math.max(a.rf, X.getActiveAttrib(a, b).name.length + 1);
              Q[d >> 2] = a.rf;
            } else if (35381 == b) {
              if (!a.sf) for (b = 0; b < X.getProgramParameter(a, 35382); ++b) a.sf = Math.max(
                a.sf,
          ...
          Wb: function(a, b, d) {
            if (d) {
              a = X.Ae.getQueryObjectEXT(pd[a], b);
              var f;
              "boolean" == typeof a ? f = a ? 1 : 0 : f = a;
              Q[d >> 2] = f;
            } else vd(1281);
          ...
          bc: function(a, b, d) {
            d ? Q[d >> 2] = X.getQuery(a, b) : vd(1281);
          },
          Xb: function(a, b, d) {
            d ? Q[d >> 2] = X.Ae.getQueryEXT(a, b) : vd(1281);
          },
          sc: function(a, b, d) {
            d ? Q[d >> 2] = X.getRenderbufferParameter(a, b) : vd(1281);
          },
          Ja: function(a, b, d, f) {
          ...
          Ka: function(a, b, d) {
            d ? 35716 == b ? (a = X.getShaderInfoLog(nd[a]), null === a && (a = "(unknown error)"), Q[d >> 2] = a ? a.length + 1 : 0) : 35720 == b ? (a = X.getShaderSource(nd[a]), Q[d >> 2] = a ? a.length + 1 : 0) : Q[d >> 2] = X.getShaderParameter(nd[a], b) : vd(1281);
          },
          La: Rd,
          Sc: Sd,
          Ma: function(a, b) {
            b = b ? vb(K, b) : "";
            if (a = kd[a]) {
              var d = a, f = d.gf, h = d.Rf, m;
              if (!f) for (d.gf = f = {}, d.Qf = {}, m = 0; m < X.getProgramParameter(d, 35718); ++m) {
              ...
              if ((h = a.Rf[h]) && f < h[0] && (f += h[1], d[f] = d[f] || X.getUniformLocation(a, b))) return f;
            } else vd(1281);
            return -1;
          },
          Nb: function(a, b, d) {
            for (var f = Fd[b], h = 0; h < b; h++) f[h] = Q[d + 4 * h >> 2];
            X.invalidateFramebuffer(a, f);
          },
          Ob: function(a, b, d, f, h, m, u) {
            for (var n = Fd[b], p = 0; p < b; p++) n[p] = Q[d + 4 * p >> 2];
            X.invalidateSubFramebuffer(a, n, f, h, m, u);
          },
          jc: function(a) {
            return X.isSync(rd[a]);
          },
          Na: function(a) {
          ...
          Hc: function(a, b, d, f, h, m) {
            X.Nf.multiDrawArraysInstancedBaseInstanceWEBGL(a, Q, b >> 2, Q, d >> 2, Q, f >> 2, Ta, h >> 2, m);
          },
          Ic: function(a, b, d, f, h, m, u, n) {
            X.Nf.multiDrawElementsInstancedBaseVertexBaseInstanceWEBGL(
              a,
              Q,
              b >> 2,
              d,
          ...
          Rb: function(a, b) {
            X.Ae.queryCounterEXT(pd[a], b);
          },
          Kc: function(a) {
            X.readBuffer(a);
          },
          Ra: function(a, b, d, f, h, m, u) {
            if (2 <= A.version) if (X.Af) X.readPixels(a, b, d, f, h, m, u);
            else {
              var n = Ud(m);
              X.readPixels(a, b, d, f, h, m, n, u >> 31 - Math.clz32(n.BYTES_PER_ELEMENT));
            }
            else (u = Vd(m, h, d, f, u)) ? X.readPixels(a, b, d, f, h, m, u) : vd(1280);
          },
          tc: function(a, b, d, f) {
          ...
          fc: function(a, b, d) {
            X.samplerParameterf(qd[a], b, d);
          },
          gc: function(a, b, d) {
            X.samplerParameteri(qd[a], b, d);
          },
          hc: function(a, b, d) {
            X.samplerParameteri(qd[a], b, Q[d >> 2]);
          },
          Sa: function(a, b, d, f) {
            X.scissor(a, b, d, f);
          },
          Ta: function(a, b, d, f) {
            for (var h = "", m = 0; m < b; ++m) {
              var u = f ? Q[f + 4 * m >> 2] : -1, n = Q[d + 4 * m >> 2];
          ...
          _a: function(a, b, d, f, h, m, u, n, p) {
            if (2 <= A.version) if (X.Xe) X.texImage2D(a, b, d, f, h, m, u, n, p);
            else if (p) {
              var v = Ud(n);
              X.texImage2D(a, b, d, f, h, m, u, n, v, p >> 31 - Math.clz32(v.BYTES_PER_ELEMENT));
            } else X.texImage2D(a, b, d, f, h, m, u, n, null);
            else X.texImage2D(a, b, d, f, h, m, u, n, p ? Vd(n, u, f, h, p) : null);
          },
          $a: function(a, b, d) {
          ...
          db: function(a, b, d, f, h, m, u, n, p) {
            if (2 <= A.version) if (X.Xe) X.texSubImage2D(a, b, d, f, h, m, u, n, p);
            else if (p) {
              var v = Ud(n);
              X.texSubImage2D(a, b, d, f, h, m, u, n, v, p >> 31 - Math.clz32(v.BYTES_PER_ELEMENT));
            } else X.texSubImage2D(a, b, d, f, h, m, u, n, null);
            else v = null, p && (v = Vd(n, u, h, m, p)), X.texSubImage2D(a, b, d, f, h, m, u, n, v);
          },
          eb: function(a, b) {
            X.uniform1f(Wd(a), b);
          },
          fb: function(a, b, d) {
            if (2 <= A.version) b && X.uniform1fv(Wd(a), S, d >> 2, b);
            else {
              if (288 >= b) for (var f = Xd[b - 1], h = 0; h < b; ++h) f[h] = S[d + 4 * h >> 2];
          ...
          pd: function(a, b, d) {
            if (2 <= A.version) b && X.uniform1iv(Wd(a), Q, d >> 2, b);
            else {
              if (288 >= b) for (var f = Yd[b - 1], h = 0; h < b; ++h) f[h] = Q[d + 4 * h >> 2];
              else f = Q.subarray(d >> 2, d + 4 * b >> 2);
              X.uniform1iv(Wd(a), f);
            }
          },
          qd: function(a, b, d) {
            X.uniform2f(Wd(a), b, d);
          },
          rd: function(a, b, d) {
            if (2 <= A.version) b && X.uniform2fv(Wd(a), S, d >> 2, 2 * b);
            else {
              if (144 >= b) for (var f = Xd[2 * b - 1], h = 0; h < 2 * b; h += 2) f[h] = S[d + 4 * h >> 2], f[h + 1] = S[d + (4 * h + 4) >> 2];
              else f = S.subarray(d >> 2, d + 8 * b >> 2);
              X.uniform2fv(Wd(a), f);
            }
          },
          nd: function(a, b, d) {
            X.uniform2i(Wd(a), b, d);
          },
          md: function(a, b, d) {
            if (2 <= A.version) b && X.uniform2iv(Wd(a), Q, d >> 2, 2 * b);
            else {
              if (144 >= b) for (var f = Yd[2 * b - 1], h = 0; h < 2 * b; h += 2) f[h] = Q[d + 4 * h >> 2], f[h + 1] = Q[d + (4 * h + 4) >> 2];
              else f = Q.subarray(d >> 2, d + 8 * b >> 2);
              X.uniform2iv(Wd(a), f);
            }
          },
          ld: function(a, b, d, f) {
            X.uniform3f(Wd(a), b, d, f);
          },
          kd: function(a, b, d) {
            if (2 <= A.version) b && X.uniform3fv(Wd(a), S, d >> 2, 3 * b);
            else {
              if (96 >= b) for (var f = Xd[3 * b - 1], h = 0; h < 3 * b; h += 3) f[h] = S[d + 4 * h >> 2], f[h + 1] = S[d + (4 * h + 4) >> 2], f[h + 2] = S[d + (4 * h + 8) >> 2];
              else f = S.subarray(d >> 2, d + 12 * b >> 2);
              X.uniform3fv(Wd(a), f);
            }
          },
          jd: function(a, b, d, f) {
            X.uniform3i(Wd(a), b, d, f);
          },
          id: function(a, b, d) {
            if (2 <= A.version) b && X.uniform3iv(Wd(a), Q, d >> 2, 3 * b);
            else {
              if (96 >= b) for (var f = Yd[3 * b - 1], h = 0; h < 3 * b; h += 3) f[h] = Q[d + 4 * h >> 2], f[h + 1] = Q[d + (4 * h + 4) >> 2], f[h + 2] = Q[d + (4 * h + 8) >> 2];
              else f = Q.subarray(d >> 2, d + 12 * b >> 2);
              X.uniform3iv(Wd(a), f);
            }
          },
          hd: function(a, b, d, f, h) {
            X.uniform4f(Wd(a), b, d, f, h);
          },
          gd: function(a, b, d) {
            if (2 <= A.version) b && X.uniform4fv(Wd(a), S, d >> 2, 4 * b);
            else {
              if (72 >= b) {
                var f = Xd[4 * b - 1], h = S;
                d >>= 2;
          ...
          Wc: function(a, b, d, f, h) {
            X.uniform4i(Wd(a), b, d, f, h);
          },
          Xc: function(a, b, d) {
            if (2 <= A.version) b && X.uniform4iv(Wd(a), Q, d >> 2, 4 * b);
            else {
              if (72 >= b) for (var f = Yd[4 * b - 1], h = 0; h < 4 * b; h += 4) f[h] = Q[d + 4 * h >> 2], f[h + 1] = Q[d + (4 * h + 4) >> 2], f[h + 2] = Q[d + (4 * h + 8) >> 2], f[h + 3] = Q[d + (4 * h + 12) >> 2];
              else f = Q.subarray(d >> 2, d + 16 * b >> 2);
              X.uniform4iv(Wd(a), f);
            }
          },
          Yc: function(a, b, d, f) {
            if (2 <= A.version) b && X.uniformMatrix2fv(Wd(a), !!d, S, f >> 2, 4 * b);
            else {
              if (72 >= b) for (var h = Xd[4 * b - 1], m = 0; m < 4 * b; m += 4) h[m] = S[f + 4 * m >> 2], h[m + 1] = S[f + (4 * m + 4) >> 2], h[m + 2] = S[f + (4 * m + 8) >> 2], h[m + 3] = S[f + (4 * m + 12) >> 2];
              else h = S.subarray(f >> 2, f + 16 * b >> 2);
              X.uniformMatrix2fv(Wd(a), !!d, h);
            }
          },
          Zc: function(a, b, d, f) {
            if (2 <= A.version) b && X.uniformMatrix3fv(Wd(a), !!d, S, f >> 2, 9 * b);
            else {
              if (32 >= b) for (var h = Xd[9 * b - 1], m = 0; m < 9 * b; m += 9) h[m] = S[f + 4 * m >> 2], h[m + 1] = S[f + (4 * m + 4) >> 2], h[m + 2] = S[f + (4 * m + 8) >> 2], h[m + 3] = S[f + (4 * m + 12) >> 2], h[m + 4] = S[f + (4 * m + 16) >> 2], h[m + 5] = S[f + (4 * m + 20) >> 2], h[m + 6] = S[f + (4 * m + 24) >> 2], h[m + 7] = S[f + (4 * m + 28) >> 2], h[m + 8] = S[f + (4 * m + 32) >> 2];
              else h = S.subarray(f >> 2, f + 36 * b >> 2);
              X.uniformMatrix3fv(Wd(a), !!d, h);
            }
          },
          _c: function(a, b, d, f) {
            if (2 <= A.version) b && X.uniformMatrix4fv(Wd(a), !!d, S, f >> 2, 16 * b);
            else {
              if (18 >= b) {
                var h = Xd[16 * b - 1], m = S;
                f >>= 2;
          ...
          kc: function(a, b, d, f) {
            X.waitSync(rd[a], b, (d >>> 0) + 4294967296 * f);
          },
          rb: (a) => {
            var b = K.length;
            a >>>= 0;
        ...
        (function() {
          function a(d) {
            ...
            if (0 == ab && (null !== fb && (clearInterval(fb), fb = null), gb)) {
              var f = gb;
              gb = null;
              f();
            }
        ...
        var Pd = w._malloc = (a) => (Pd = w._malloc = Ma.Bd)(a), yc = w._free = (a) => (yc = w._free = Ma.Dd)(a), xc = (a) => (xc = Ma.Ed)(a);
        w.__embind_initialize_bindings = () => (w.__embind_initialize_bindings = Ma.Fd)();
        var Ee = (a, b) => (Ee = Ma.Gd)(a, b), Fe = () => (Fe = Ma.Hd)(), Ge = (a) => (Ge = Ma.Id)(a);
        w.dynCall_viji = (a, b, d, f, h) => (w.dynCall_viji = Ma.Jd)(a, b, d, f, h);
        w.dynCall_vijiii = (a, b, d, f, h, m, u) => (w.dynCall_vijiii = Ma.Kd)(a, b, d, f, h, m, u);
        w.dynCall_viiiiij = (a, b, d, f, h, m, u, n) => (w.dynCall_viiiiij = Ma.Ld)(a, b, d, f, h, m, u, n);
        w.dynCall_jii = (a, b, d) => (w.dynCall_jii = Ma.Md)(a, b, d);
        w.dynCall_vij = (a, b, d, f) => (w.dynCall_vij = Ma.Nd)(a, b, d, f);
        w.dynCall_jiiiii = (a, b, d, f, h, m) => (w.dynCall_jiiiii = Ma.Od)(a, b, d, f, h, m);
        w.dynCall_jiiiiii = (a, b, d, f, h, m, u) => (w.dynCall_jiiiiii = Ma.Pd)(a, b, d, f, h, m, u);
        w.dynCall_jiiiiji = (a, b, d, f, h, m, u, n) => (w.dynCall_jiiiiji = Ma.Qd)(a, b, d, f, h, m, u, n);
        w.dynCall_ji = (a, b) => (w.dynCall_ji = Ma.Rd)(a, b);
        w.dynCall_iijj = (a, b, d, f, h, m) => (w.dynCall_iijj = Ma.Sd)(a, b, d, f, h, m);
        w.dynCall_iiiji = (a, b, d, f, h, m) => (w.dynCall_iiiji = Ma.Td)(a, b, d, f, h, m);
        w.dynCall_iiji = (a, b, d, f, h) => (w.dynCall_iiji = Ma.Ud)(a, b, d, f, h);
        w.dynCall_iijjiii = (a, b, d, f, h, m, u, n, p) => (w.dynCall_iijjiii = Ma.Vd)(a, b, d, f, h, m, u, n, p);
        w.dynCall_iij = (a, b, d, f) => (w.dynCall_iij = Ma.Wd)(a, b, d, f);
        w.dynCall_vijjjii = (a, b, d, f, h, m, u, n, p, v) => (w.dynCall_vijjjii = Ma.Xd)(a, b, d, f, h, m, u, n, p, v);
        w.dynCall_jiji = (a, b, d, f, h) => (w.dynCall_jiji = Ma.Yd)(a, b, d, f, h);
        w.dynCall_viijii = (a, b, d, f, h, m, u) => (w.dynCall_viijii = Ma.Zd)(a, b, d, f, h, m, u);
        w.dynCall_iiiiij = (a, b, d, f, h, m, u) => (w.dynCall_iiiiij = Ma._d)(a, b, d, f, h, m, u);
        w.dynCall_iiiiijj = (a, b, d, f, h, m, u, n, p) => (w.dynCall_iiiiijj = Ma.$d)(a, b, d, f, h, m, u, n, p);
        w.dynCall_iiiiiijj = (a, b, d, f, h, m, u, n, p, v) => (w.dynCall_iiiiiijj = Ma.ae)(a, b, d, f, h, m, u, n, p, v);
        function ne(a, b) {
          var d = Fe();
          try {
            return Wa.get(a)(b);
        ...
        function Ce(a, b, d, f, h, m, u, n, p, v) {
          var E = Fe();
          try {
        ...
        function te(a, b, d, f, h, m, u, n) {
          var p = Fe();
          try {
            return Wa.get(a)(b, d, f, h, m, u, n);
          } catch (v) {
            Ge(p);
            if (v !== v + 0) throw v;
            Ee(1, 0);
        ...
        function ue(a, b, d, f, h, m, u, n, p, v) {
          var E = Fe();
          try {
        ...
        function Je() {
          function a() {
            if (!He && (He = true, w.calledRun = true, !Na)) {
              tb(Ya);
              aa(w);
          ...
          if (!(0 < ab)) {
            if (w.preRun) for ("function" == typeof w.preRun && (w.preRun = [w.preRun]); w.preRun.length; ) $a();
            tb(Xa);
            0 < ab || (w.setStatus ? (w.setStatus("Running..."), setTimeout(function() {
              setTimeout(function() {
                w.setStatus("");
              }, 1);
              a();
...
//# sourceMappingURL=canvaskit-wasm_full.js.map
